...
def train(hyp, opt, device, tb_writer=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if (epoch + 1) % opt.test_step == 0 or final_epoch:
                save_FLAG = True
            ...
            save = (save_FLAG) or (final_epoch and not opt.evolve)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[1600, 1600], help='train,test sizes')
    ...
    parser.add_argument('--test_step', type=int, default=300, help='how many epochs test once')
